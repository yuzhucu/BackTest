...
class DataSliceHandle(object):
    ...
    def SendDataEvent(self,type):
        ...
        new_event.dict['time'] = self.__time
        new_event.dict['open'] = self.__open
        new_event.dict['high'] = self.__high
        new_event.dict['low'] = self.__low
        new_event.dict['volume'] = self.__volume
        new_event.dict['magic'] = self.__magic
        self.__eventEngine.SendEvent(new_event)
